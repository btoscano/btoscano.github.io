...
function Redazione() {
  return <div className="redazione">
        ...
        <h3 className="h3">Example h3</h3>
        <h4 className="h4">Example h4</h4>
        <h5 className="h5">Example h5</h5>
        <h5 className="h5--reg">Example h5 reg</h5>
        <div className="jumbo">Jumbo</div>
        ...
        <div className="paragraph--smaller">paragraph smaller</div>
        <div className="paragraph--serif">paragraph serif</div>
